...
2.1. <ins>Заполнение отсутствующих Price Per Unit:</ins></br>
...
3.2. <ins>Анализ среднего чека:</ins></br>
   ...
   - Округлить до двух знаков после запятой.</br>
...
4.2. <ins>Продажи по дням недели:</ins></br>
   - Рассчитать среднюю сумму продаж (`Total Spent`) для каждого дня недели.</br>
   - Вывести результаты, отсортированные по дням недели.</br>

4.3. <ins>Продажи по месяцам:</ins></br>
   - Рассчитать среднюю сумму продаж (`Total Spent`)  для каждого месяца.</br>
   - Вывести результаты, отсортированные по месяцам.</br>

4.4. <ins>Признаки клиента:</ins></br>
   - Рассчитать `customer_lifetime_value` (**CLV**) для каждого клиента как общую сумму (`Total Spent`), потраченную этим клиентом за все транзакции.  </br>
   - Вывести Топ-10 клиентов по их **CLV** (`customer_id` и их **CLV**).</br>
   
## Выполнение задания:
Задание выполнено с использованием **PySpark**. </br>
Все детали решения по шагам можно увидеть в файле **.ipynb** текущего репозитория. 
